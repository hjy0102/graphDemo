...
d3.chart.graphDemo = function() {
    console.log("hello chart.graphDemo");

    var width = 980,
        height = 500;

    var svg, graph, graphData, diameter, activeNode;
    ...
    function chart(){
        ...
        var nodes = graph.nodes(graphData),
    ...
    /**
     * Add the node dependents in the graph
     * @param {Array} nodes
     */
